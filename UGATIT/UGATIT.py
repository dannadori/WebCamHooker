...
class UGATIT(object) :
    ...
    def test(self):
        tf.global_variables_initializer().run(sess)
    ...
    def load_model(self, sess, checkpoint_dir = 'UGATIT/checkpoint/'):
    ...
    def predict(self,img):
        ...
        fake_img = self.sess.run(self.test_fake_B, feed_dict = {self.test_domain_A : img})
